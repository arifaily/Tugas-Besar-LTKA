...
RIC_ENGINE_URL  = "http://YOUR_ECS_PUBLIC_IP:8000"

# ── Huawei Cloud DIS ──────────────────────────────────────
DIS_ENDPOINT    = "https://dis.ap-southeast-1.myhuaweicloud.com"
DIS_STREAM_NAME = "qos-ric-stream"
DIS_PROJECT_ID  = "YOUR_PROJECT_ID"
DIS_AK          = "YOUR_ACCESS_KEY"       # Access Key
DIS_SK          = "YOUR_SECRET_KEY"       # Secret Key
DIS_REGION      = "ap-southeast-1"
...
PRB_MIN_INDUSTRY   = 15    # PRB minimum untuk user industri
PRB_MIN_NORMAL     = 5     # PRB minimum untuk user biasa
